    ...
    <div className="flex flex-col items-center gap-10 text-[#dbd8e3] mt-28 mb-10">
      <h1 className=" text-center text-[2.5rem] font-extrabold mb-14">Bienvenue sur <br /> Ez-Task</h1>
        <div className="flex gap-28 mt-10 md:mt-28">
          <section className="w-[90vw] lg:w-[40vw]  p-9 border-[#dbd8e3] border-[1px] rounded-3xl shadow-md shadow-black font-semibold backdrop-blur-lg flex flex-col items-center justify-center gap-10">
          ...
          <img src="/images/simple.jpeg" alt="" className="hidden lg:block w-[30vw] rounded-3xl shadow-md shadow-black  p-1 border-[#dbd8e3] border-[1px] blur-[1px]"/>
        </div>
        <div className="flex gap-28 md:mt-28">
          <img src="/images/titre2.webp" alt="" className="hidden lg:block w-[30vw] rounded-3xl shadow-md shadow-black  p-1 border-[#dbd8e3] border-[1px] blur-[1px]"/>
          <section className="w-[90vw] lg:w-[40vw]  p-9 border-[#dbd8e3] border-[1px] rounded-3xl shadow-md shadow-black font-semibold backdrop-blur-lg flex flex-col items-center justify-center gap-10">
        ...
        <img src="/images/titre3.jpg" alt="" className="hidden lg:block w-[30vw] rounded-3xl shadow-md shadow-black  p-1 border-[#dbd8e3] border-[1px] blur-[1px]"/>
        </div>
        <div className="flex gap-28 md:mt-28">
        <img src="/images/titre4.jpg" alt="" className="hidden lg:block w-[30vw] rounded-3xl shadow-md shadow-black  p-1 border-[#dbd8e3] border-[1px] blur-[1px]"/>
        <section className="w-[90vw] lg:w-[40vw]  p-9 border-[#dbd8e3] border-[1px] rounded-3xl shadow-md shadow-black font-semibold backdrop-blur-lg flex flex-col items-center justify-center gap-10">
